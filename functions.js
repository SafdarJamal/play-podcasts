...
const { serveFunctions } = require('netlify-cli/src/utils/serve-functions');
...
const { NETLIFYDEVLOG, NETLIFYDEVERR } = {
  NETLIFYDEV: `${chalk.greenBright('◈')} ${chalk.rgb(
    40,
    180,
    170
  )('Netlify Dev')} ${chalk.greenBright('◈')}`,
