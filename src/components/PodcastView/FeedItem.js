...
export default function FeedItem({
  ...
  if (isPlaying(player, episode)) {
    button = (
      <button
        ...
        className="c-player-button c-player-button--large c-player-button--flush"
      >
    ...
    button = (
      <button
        onClick={() => onPlayButtonClick(episode)}
        className="c-player-button c-player-button--large c-player-button--flush"
      >
  ...
  return (
    ...
    >
      ...
      <div className="c-feed-item__button u-margin-right">{button}</div>
